...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("BMI="+MyUtil.calculateBMI(65,1.75));
       System.out.println("Average="+MyUtil.average(10,15,20));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       ...
       bankAccount1.transfer(10000,bankAccount2);

       System.out.println(person1.toString());
       System.out.println(bankAccount1.toString());
       System.out.println("Account1 balance = "+bankAccount1.getBalance());

       System.out.println(person2.toString());
       System.out.println(bankAccount2.toString());
       System.out.println("Account2 balance = "+bankAccount2.getBalance());
   }
}
